...
const impactMetrics = [
  ...
  },
  {
    ...
    icon: TrendingDown,
    metric: "EPSS/SSVC",
    label: "Risk-Based Triage Delivered",
    description:
      "Implemented EPSS and SSVC-driven triage frameworks, replacing pure CVSS scoring and delivering quantifiable reductions in critical exposure",
  },
  {
    id: 5,
    icon: Users,
  ...
  },
  {
    ...
    icon: Target,
    metric: "Board-Level",
    label: "Remediation Funding Secured",
    description:
      "Identified architectural security risks and built the business case that secured executive and board-level investment in remediation programs",
  },
];
